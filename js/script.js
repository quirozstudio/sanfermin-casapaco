  ...
  function updateMenu(menuId) {
    ...
    courseElements.forEach((courseElement, courseIndex) => {
      ...
      dishElements.forEach((dishElement, dishIndex) => {
        ...
        let descriptionElement = dishElement.querySelector(":scope > .menu-dish-description");
        if (!descriptionElement) {
          descriptionElement = document.createElement("p");
          descriptionElement.className = "menu-dish-description";
          dishElement.insertBefore(descriptionElement, dishElement.querySelector("small"));
        }
        descriptionElement.textContent = translated(dish.description);
